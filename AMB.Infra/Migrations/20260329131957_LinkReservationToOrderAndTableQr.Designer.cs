...
namespace AMB.Infra.Migrations
{
    ...
    [Migration("20260329131957_LinkReservationToOrderAndTableQr")]
    partial class LinkReservationToOrderAndTableQr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AMB.Domain.Entities.GIItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("IssuedQuantity")
                        .HasColumnType("real");
                    ...
                    b.Property<float>("RequestedQuantity")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("AMB.Domain.Entities.GoodIssueNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GoodIssueNotes", (string)null);
                });
            ...
            modelBuilder.Entity("AMB.Domain.Entities.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMB.Domain.Entities.PurchaseRequestItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AMB.Domain.Entities.ReservationWaiterAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReservationWaiterAssignments", (string)null);
                });
            ...
            modelBuilder.Entity("AMB.Domain.Entities.TableCanvasShape", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TableCanvasShapes", (string)null);
                });
            ...
            modelBuilder.Entity("AMB.Domain.Entities.WastageEntryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("WastageRecordId")
                        .HasColumnType("int");

                    b.Property<string>("WastageType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("WastageRecordId");

                    b.ToTable("WastageEntryItems", (string)null);
                });

            modelBuilder.Entity("AMB.Domain.Entities.WastageRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("WastageEntryNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("WastageRecords", (string)null);
                });
            ...
            modelBuilder.Entity("AMB.Domain.Entities.GIItem", b =>
                {
                    b.HasOne("AMB.Domain.Entities.GoodIssueNote", "GoodIssueNote")
                        .WithMany("GIItems")
            ...
            modelBuilder.Entity("AMB.Domain.Entities.Order", b =>
                {
                    b.HasOne("AMB.Domain.Entities.Reservation", "Reservation")
                        .WithMany()
            ...
            modelBuilder.Entity("AMB.Domain.Entities.Reservation", b =>
                {
                    b.HasOne("AMB.Domain.Entities.Employee", "AssignedWaiter")
                        .WithMany()
            ...
            modelBuilder.Entity("AMB.Domain.Entities.ReservationWaiterAssignment", b =>
                {
                    ...
                    b.HasOne("AMB.Domain.Entities.Employee", "Waiter")
                        .WithMany()
            ...
            modelBuilder.Entity("AMB.Domain.Entities.TableCanvasShape", b =>
                {
                    b.HasOne("AMB.Domain.Entities.Table", "AssignedTable")
                        .WithMany()
            ...
            modelBuilder.Entity("AMB.Domain.Entities.WastageEntryItem", b =>
                {
                    ...
                    b.HasOne("AMB.Domain.Entities.WastageRecord", "WastageRecord")
                        .WithMany("WastageEntryItems")
                        .HasForeignKey("WastageRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InventoryItem");

                    b.Navigation("WastageRecord");
                });
            ...
            modelBuilder.Entity("AMB.Domain.Entities.WastageRecord", b =>
                {
                    b.Navigation("WastageEntryItems");
                });
